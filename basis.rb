...
# Data types
# To store a text form with a string: name = "Karen"
# To store a whole number with an integer: age = 75
# To store a floating point number, decimal number: gpa = 3.2
# To store true or false with a boolean: is_tall = true
# nil data type basically means that it doesn't have a value: flaws = nil
